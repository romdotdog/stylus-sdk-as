...
import { load_bytes32, output, store_bytes32, args, msg_value, contract_address, emit } from "./util";
import { Address } from "./Address";
import { Event as InternalEvent } from "./Event";
...
// event NumberChanged(indexed uint256 n)
